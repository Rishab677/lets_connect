...
<div class="container">
    <div class="box">
        <div class="image">
            <img src="${pageContext.request.contextPath}/Resources/Image/login/register.png" alt="Register Image">
        </div>
        <div class="content">
            <h1>Registration</h1>
                ...
                <div class="formDetails">
                    ...
                    <div class="field">
                        ...
                        <select id="gender" name="gender" required>
                            <option value="" <%= request.getAttribute("gender") == null ? "selected" : "" %>>-- Select Gender --</option>
                    ...
                    <div class="field">
                        ...
                        <input type="text" id="province" name="province"
                               ...
                               value="<%= request.getAttribute("province") != null ? request.getAttribute("province") : "" %>" required>
                    </div>
