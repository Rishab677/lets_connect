    ...
    <div class="wrap">
        ...
        <div class="container">
            ...
            <div id="addProductDiv">
                <form id="productForm" action="${pageContext.request.contextPath}/UpdateProduct" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="productId" value="${editProduct != null ? editProduct.id : ''}" />
                    <input type="text" name="product_name" placeholder="Product Name" required value="${editProduct != null ? editProduct.name : ''}" />
                    <input type="text" name="product_brand" placeholder="Brand" required value="${editProduct != null ? editProduct.brand : ''}" />
                    <input type="text" name="product_price" placeholder="Price" required value="${editProduct != null ? editProduct.price : ''}" />
                    <textarea name="product_specifications" placeholder="Specifications" rows="3" required>${editProduct != null ? editProduct.specifications : ''}</textarea>
            ...
            <form id="deleteForm" action="${pageContext.request.contextPath}/UpdateProduct" method="post" style="display:none;">
