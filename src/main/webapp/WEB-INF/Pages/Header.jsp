        ...
        <div class="top">
            ...
            <div class="icons">
                <a href="${pageContext.request.contextPath}/Addtocart"> 
                    <img src="${pageContext.request.contextPath}/Resources/Image/login/shopping-cart.png" alt="Cart" title="Cart" />
                </a> 
                <a href="${pageContext.request.contextPath}/profile"> 
                    <img src="${pageContext.request.contextPath}/Resources/Image/login/user.png" alt="User" title="User" />
